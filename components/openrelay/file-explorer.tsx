  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center gap-1 px-3 py-2 border-b border-zinc-800 shrink-0">
        ...
        <div className="flex items-center gap-1 text-xs text-zinc-500 overflow-x-auto scrollbar-none">
          <button
            onClick={() => setCurrentPath("/")}
            className="hover:text-zinc-300 whitespace-nowrap shrink-0"
          >
            /
          </button>
          {pathParts.map((part, i) => {
            ...
            return (
              <span key={full} className="flex items-center gap-1">
                ...
                <button
                  onClick={() => setCurrentPath(full)}
                  className="hover:text-zinc-300 whitespace-nowrap"
                >
                  {part}
                </button>
              </span>
